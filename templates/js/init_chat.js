(function() {
    ...
    function createLoadingIndicator() {
        return `
            <div id="chat-loading-indicator" style="
                display: flex;
...
<style>
  ...
  #chatbox {
    ...
    overflow-y: auto;
    padding: 10px;
    background-color: var(--goglobe-site-bg-color, #f5f5f5);
  }
  ...
  .htmx-request #chat-loading-indicator {
    display: flex !important;
  }

  .htmx-request .chat-loaded-content {
...
<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-x-icon lucide-x"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>        </div>
  ...
  <div class="resize-indicator"></div>
    ...
    `;
        ...
        // Enhanced HTMX event handling for loading states
            ...
            if (evt.target.id === "chatbox") {
                ...
                if (loadingIndicator) {
                    loadingIndicator.innerHTML = `
                        <div style="text-align: center; padding: 20px; color: #ff5800;">
