...
(function ($) {
  ...
  var FrenifyGoGlobe = {
        ...
        if (name === "" || email === "" || message === "") {
          ...
          $.post(
            ...
            function (data) {
              ...
              if (
                $(".fn_contact_form .returnmessage span.contact_error").length
              ) {
    ...
    //             $(".fn__chatbot .chat__group.new ul").append(
    //               newChatToRightPanel,
    //             );
    //           } else {
    //             $(".fn__chatbot .sidebar_content").prepend(
    ...
    frenifyChat: function () {
      ...
      var allJokes = [
        ...
        "What do s# printers eat before a race?<> Nothing—they fast.",
      ...
      $(".goglobe_fn_pricing .toggle_in a")
        ...
        .on("click", function () {
          ...
          if (!element.hasClass("active")) {
            ...
            parent
              .find(".bg")
              .css({ left: offset, width: element.outerWidth(true, true) });
          }
          return false;
        });
    },
